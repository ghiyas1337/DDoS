...
Type exit To Stop
`);
permen.question(`${back_putih}${teksmerah}Dzky DoS${Reset}➔ ${back_putih}${teksmerah}WiFi Killer${Reset}: \n`, async (yakin) => {
if (yakin === 'exit') {
...
permen.question(`${back_putih}${teksmerah}Dzky DoS${Reset}➔ ${back_putih}${teksmerah}Chat AI${Reset}: `, async (yakin) => {
if (yakin === 'exit') {
...
${creatorCredits}`);
    ...
    console.log(`Dzky Ai Ragbot Started
